  ...
  return (
    <section className="flex justify-between mt-4">
      <button
        ...
        className="text-xs text-gray-800 font-semibold hover:text-gray-50 bg-sky-200 hover:bg-sky-500 rounded-lg py-1 px-2 transition-colors duration-200 ease-linear disabled:bg-gray-200 disabled:text-gray-900"
      >
        Previous
      </button>
